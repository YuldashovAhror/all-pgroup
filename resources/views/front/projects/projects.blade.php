...
<head>
	...
	<title>ALL-P Group | Наши проекты</title>
</head>
<body>
	...
	<div class="mobile-menu">
		<div class="mobile-menu__wrap">
			<ul class="mobile-menu__list">
				...
				<li>
					<a href="projects.html" class="current">
						Наши проекты
					</a>
				</li>
				<li>
	...
	<section class="page-head">
		<div class="page-head__img">
			<img src="img/project-bg.jpg" alt="contact">
		</div>
			...
			<ul class="projects-list">
				<li class="projects-item">
					<div class="projects-item__img">
						<img src="img/project1.jpg" alt="projects">
					</div>
					<div class="projects-item__name">
						Отель Premium Class HILTON GARDEN INN
					</div>
					<a href="single.html" class="projects-item__btn btn btn-white">
						Узнать подробнее
					</a>
				</li>
				<li class="projects-item">
					...
					<div class="projects-item__name">
						Завод минеральных вод IDS BORJOMI INTERNATIONAL
					</div>
					<a href="single.html" class="projects-item__btn btn btn-white">
						Узнать подробнее
					</a>
