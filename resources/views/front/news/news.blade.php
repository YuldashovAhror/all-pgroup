...
<head>
	...
	<title>ALL-P Group | Новости</title>
</head>
<body>
	...
	<section class="page-head">
		<div class="page-head__img">
			<img src="img/news-bg.jpg" alt="contact">
		</div>
	...
	<section class="news-page">
		<div class="container">
			<ul class="news-choose">
				<li class="current">Узбекистан</li>
				<li>Грузия</li>
			</ul>
			<div class="news-tabs">
				<div class="news-tab current">
					<div class="news-item">
						<div class="news-item__img">
							<img src="img/project1.jpg" alt="img">
						</div>
