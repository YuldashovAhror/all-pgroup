...
<head>
	...
	<title>ALL-P Group | Услуги</title>
</head>
<body>
	...
	<header class="header">
		<div class="container">
			<div class="header__logo">
				<a href="index.html">
					<img src="img/logo.svg" alt="ALL-P Group" title="ALL-P group">
				</a>
			</div>
	...
	<section class="page-head">
		<div class="page-head__img">
			<img src="img/services/bg.jpg" alt="services">
		</div>
			...
			<ul class="services-list">
				<li class="services-list__item">
					<div class="services-list__img">
						<img src="img/services/2.jpg" alt="service">
					</div>
					<div class="services-list__wrap">
						...
						<div class="services-list__name">
							ТОППИНГ БЕТОННЫХ ПОЛОВ
						</div>
						<div class="services-list__text">
							Топпинги представляют собой сухие смеси, главной задачей которых является повышение прочности бетонного пола. В их состав входит цемент, а также ряд наполнителей - корунд, металлическая стружка, кварц. Укрепление бетонного пола топпингом дает массу преимуществ бетону.
						</div>
						<a href="#" class="services-list__btn btn btn-white">
							Читать подробнее
						</a>
					</div>
				</li>
				...
				<li class="services-list__item">
					<div class="services-list__img">
						<img src="img/services/4.jpg" alt="service">
					</div>
					<div class="services-list__wrap">
						<div class="services-list__title">
							БЕТОННАЯ СТЯЖКА
						...
						<div class="services-list__text">
							Топпинги представляют собой сухие смеси, главной задачей которых является повышение прочности бетонного пола. В их состав входит цемент.
						</div>
						<a href="#" class="services-list__btn btn btn-white">
							Читать подробнее
						</a>
				...
				<li class="services-list__item">
					<div class="services-list__img">
						<img src="img/services/1.jpg" alt="service">
					</div>
					<div class="services-list__wrap">
						<div class="services-list__title">
							БЕТОННЫЕ ПОКРЫТИЯ
						...
						<div class="services-list__name">
							ПОЛУСУХАЯ БЕТОННАЯ СТЯЖКА
						</div>
						<div class="services-list__text">
							Топпинги представляют собой сухие смеси, главной задачей которых является повышение прочности бетонного пола. В их состав входит цемент, а также ряд наполнителей - корунд, металлическая стружка, кварц. Укрепление бетонного пола топпинго
							Топпинги представляют собой сухие смеси, главной задачей которых является повышение прочности бетонного пола. В их состав входит цемент, а также ряд наполнителей - корунд, металлическая стружка, кварц. Укрепление бетонного пола топпинго
						</div>
						<a href="#" class="services-list__btn btn btn-white">
							Читать подробнее
	...
	<footer class="footer">
			...
			<div class="container">
				<div class="footer-col">
					<div class="footer__logo">
						<a href="index.html">
							<img src="img/logo-white.svg" alt="ALL-P Group" title="ALL-P Group">
						</a>
					</div>
				...
				<div class="footer-col">
					<div class="footer-item">
						...
						<div class="footer-item__text">
							700077 г. Ташкент, Мирзо-Улугбекский район, проспект Мустакиллик 67
						</div>
					</div>
					<div class="footer-item">
						<div class="footer-item__title">
				...
				<div class="footer-col">
					<a href="#" class="footer-arrow">
						<svg width="28" height="9" viewBox="0 0 28 9" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M14 1.22392e-06L7.86805e-07 9L13.9998 5.75L28 9L14 1.22392e-06Z" fill="white"/>
						</svg>
					</a>
				</div>
			</div>
		...
		<div class="footer-bot">
			<div class="container">
				<p>© 2023 All-P. Все права защищены.</p>
